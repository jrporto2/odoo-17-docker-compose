...
sudo scp /etc/ssl/certs/odoo-selfsigned.crt $DESTINATION/datadrive/nginx/cert
sudo scp /etc/ssl/private/odoo-selfsigned.key $DESTINATION/datadrive/nginx/cert
