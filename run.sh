...
sudo chmod 700 datadrive/
sudo chown -R 999:999 datadrive/postgres/db
sudo chown -R 101:101 datadrive/odoo
sudo chown -R 5050:5050 datadrive/pgadmin
sudo chown -R 101:101  datadrive/nginx
# Run Odoo
